...
export default function BillingPage() {
  ...
  return (
    <div className="page-shell-ats max-w-6xl">
      ...
      <section className="billing-hero relative overflow-hidden rounded-3xl border border-stone-800/10 bg-stone-950 text-white shadow-xl">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -top-24 -right-16 w-80 h-80 rounded-full bg-brand-500/25 blur-3xl transition-transform duration-700 group-hover:scale-110" />
      ...
      <section className="space-y-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 stagger-children">
