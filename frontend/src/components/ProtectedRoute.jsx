...
function freelancerCanOpen(pathname) {
...
export default function ProtectedRoute({ children, requiredRoles }) {
  ...
  // Org-create setup is only for users who do not belong to an organization yet.
  // Invited teammates already have organizationId and must skip setup.
  if (
    user &&
  ...
  if (user?.role === 'freelancer' && !freelancerCanOpen(location.pathname)) {
    return <ForbiddenPage />;
  }
