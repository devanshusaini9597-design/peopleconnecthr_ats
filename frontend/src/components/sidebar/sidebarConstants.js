...
export const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      { labelKey: 'nav.items.team', label: 'Team', path: '/team', icon: UserCog, roles: ['owner', 'admin', 'hr_manager'], module: 'modules.team' },
      { labelKey: 'nav.items.organization', label: 'Organization', path: '/organization', icon: Building2, roles: ['owner', 'admin', 'hr_manager'], module: 'modules.organization' },
      { labelKey: 'nav.items.candidateFields', label: 'Candidate Fields', path: '/organization/candidate-fields', icon: Columns3, roles: ['owner', 'admin', 'hr_manager'], module: 'modules.organization' },
      { labelKey: 'nav.items.companyBrand', label: 'Company Brand', path: '/company-brand', icon: Palette, roles: ['owner', 'admin', 'hr_manager'], feature: 'careers.companyBrand', module: 'modules.companyBrand' },
      { labelKey: 'nav.items.integrations', label: 'Integrations', path: '/organization/integrations', icon: Plug, roles: ['owner', 'admin', 'hr_manager'], anyIntegration: true, module: 'modules.integrations' },
      { labelKey: 'nav.items.auditLog', label: 'Audit Log', path: '/organization/audit-log', icon: ScrollText, roles: ['owner', 'admin', 'hr_manager'], feature: 'audit.log', module: 'modules.auditLog' },
      { labelKey: 'nav.items.customRoles', label: 'Custom Roles', path: '/organization/custom-roles', icon: ShieldPlus, roles: ['owner', 'admin', 'hr_manager'], feature: 'team.customRoles', module: 'modules.customRoles' },
      { labelKey: 'nav.items.sso', label: 'Single Sign-On', path: '/organization/sso', icon: KeyRound, roles: ['owner', 'admin', 'hr_manager'], feature: 'sso', module: 'modules.sso' },
      { labelKey: 'nav.items.security', label: 'Security', path: '/organization/security', icon: Shield, roles: ['owner', 'admin', 'hr_manager'], feature: 'security.mfa', module: 'modules.security' },
      { labelKey: 'nav.items.webhooksApi', label: 'Webhooks & API', path: '/organization/webhooks-api', icon: Webhook, roles: ['owner', 'admin', 'hr_manager'], feature: 'integrations.webhooksReadOnly', module: 'modules.webhooks' },
      { labelKey: 'nav.items.scheduledReports', label: 'Scheduled Reports', path: '/organization/scheduled-reports', icon: CalendarClock, roles: ['owner', 'admin', 'hr_manager'], feature: 'reports.custom', module: 'modules.scheduledReports' },
  ...
  },
  {
    ...
    title: 'Settings',
    icon: Settings,
    roles: ['owner', 'admin', 'hr_manager', 'hr_recruiter', 'sales', 'recruiter', 'interviewer', 'readonly', 'other'],
    items: [
      { labelKey: 'nav.items.emailTemplates', label: 'Email Templates', path: '/email-templates', icon: Mail, roles: ['owner', 'admin', 'hr_manager', 'hr_recruiter', 'recruiter'], module: 'modules.emailTemplates' },
      { labelKey: 'nav.items.emailSettings', label: 'Email Settings', path: '/email-settings', icon: Settings, roles: ['owner', 'admin', 'hr_manager'], feature: 'integrations.byoEmail', module: 'modules.emailSettings' },
      { labelKey: 'nav.items.pushNotifications', label: 'Push Notifications', path: '/push-notifications', icon: Bell, roles: ['owner', 'admin', 'hr_manager', 'hr_recruiter', 'recruiter', 'interviewer'], feature: 'push.notifications', module: 'modules.pushNotifications' },
      { labelKey: 'nav.items.profile', label: 'Profile', path: '/settings', icon: User, roles: ['owner', 'admin', 'hr_manager', 'hr_recruiter', 'sales', 'recruiter', 'interviewer', 'readonly', 'other'], module: 'modules.profile' },
    ]
  },
  {
    key: 'billing',
