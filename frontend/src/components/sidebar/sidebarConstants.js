...
export const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { labelKey: 'nav.items.mis', label: 'MIS', path: '/mis', icon: Megaphone, roles: ['owner', 'admin', 'hr_manager', 'hr_recruiter', 'sales', 'recruiter'], hideForRoles: ['freelancer'], module: 'modules.mis' },
  ...
  },
  {
    ...
    items: [
      ...
      { labelKey: 'nav.items.customRoles', label: 'Roles & permissions', path: '/organization/custom-roles', icon: ShieldPlus, roles: ['owner', 'admin', 'hr_manager'], feature: 'team.customRoles', module: 'modules.customRoles' },
  ...
  },
  {
    ...
    title: 'Settings',
    icon: Settings,
    roles: ['owner', 'admin', 'hr_manager', 'hr_recruiter', 'sales', 'recruiter', 'interviewer', 'readonly', 'other', 'freelancer'],
    items: [
      ...
      { labelKey: 'nav.items.emailReports', label: 'Email Reports', path: '/email-reports', icon: Inbox, roles: ['owner', 'admin', 'hr_manager', 'hr_recruiter', 'recruiter'], hideForRoles: ['freelancer'], module: 'modules.emailTemplates' },
...
export const ROLE_BADGE = {
  ...
  hr_recruiter: 'bg-emerald-500/15 text-emerald-300 border-emerald-500/30',
  recruiter: 'bg-emerald-500/15 text-emerald-300 border-emerald-500/30',
  sales: 'bg-orange-500/15 text-orange-300 border-orange-500/30',
  freelancer: 'bg-indigo-500/15 text-indigo-300 border-indigo-500/30',
  ...
  other: 'bg-stone-500/15 text-stone-400 border-stone-500/30',
};
