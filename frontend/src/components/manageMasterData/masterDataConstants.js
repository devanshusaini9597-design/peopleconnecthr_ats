...
export const CATALOG = {
  ...
  'CTC Bands': {
    ...
    tip: 'Same values as the Add Candidate CTC dropdown. Edit or add bands here — they sync instantly.',
  ...
  'Notice Periods': {
    ...
    tip: 'Same values as the Add Candidate notice dropdown. Edit or add periods here — they sync instantly.',
