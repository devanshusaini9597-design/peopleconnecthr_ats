...
export default function OrganizationSettingsPage() {
    ...
    return (
      <div className="page-shell-ats">
        <div className="flex min-h-[60vh] flex-col items-center justify-center gap-3">
          ...
          <p className="text-sm text-stone-500 font-medium">Loading organization…</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="page-shell-ats max-w-6xl pb-24">
      <PageHeader
        icon={Building2}
          ...
          {activeTab === 'general' && (
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="dropzone-ats flex flex-col items-center justify-center text-center p-6 cursor-pointer group">
              ...
              <div className="pt-6 border-t border-stone-100 grid md:grid-cols-3 gap-6">
                <div>
                  <label className="label-ats">Timezone</label>
                  <div className="relative">
                ...
                <div>
                  <label className="label-ats">Currency</label>
                  <div className="relative">
              ...
              <div>
                ...
                <div className="bg-stone-50 rounded-xl p-2 space-y-2 border border-stone-100 max-w-2xl">
                  {org.atsSettings.pipelineStages.map((stage, i) => (
                    <div
                      key={i}
                      className="flex items-center gap-3 bg-white p-3 rounded-xl border border-stone-200/80 shadow-sm group hover:border-brand-200 hover:shadow-md hover:bg-brand-50/30 transition-all duration-200"
                    >
                      <GripVertical className="w-4 h-4 text-stone-400 cursor-grab group-hover:text-brand-500 transition-colors" />
                      <span className="flex-1 text-sm font-medium text-stone-700">{stage}</span>
                      <button className="p-1.5 text-stone-400 hover:text-red-500 hover:bg-red-50 rounded-lg opacity-0 group-hover:opacity-100 transition-all">
          ...
          {activeTab === 'team' && (
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div>
                  <h3 className="text-lg font-medium text-stone-900">Team</h3>
              ...
              <div className={`space-y-6 transition-opacity duration-300 ${!org.atsSettings.careersPageEnabled ? 'opacity-50 pointer-events-none' : ''}`}>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="textarea-ats resize-none"
      ...
      {activeTab !== 'team' && (
        <div className="fixed bottom-0 inset-x-0 z-40 border-t border-stone-200/80 bg-white/90 backdrop-blur-md">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-2">
            <button
              type="button"
