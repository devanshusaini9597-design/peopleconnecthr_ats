...
const ACTION_PERMISSIONS = [
  ...
  'freelance.viewAll', 'freelance.manage', 'freelance.approve', 'freelance.scorecard',
  'team.invite', 'team.remove', 'team.changeRole', 'team.resetPassword',
...
const PERMISSION_CATALOG = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'modules.freelanceReview', label: 'Freelance Review', kind: 'module' },
      { key: 'freelance.viewAll', label: 'View all freelance desks (Owner)', kind: 'action' },
      { key: 'freelance.manage', label: 'Manage freelance handoffs', kind: 'action' },
      { key: 'freelance.approve', label: 'Approve gated stage moves', kind: 'action' },
      { key: 'freelance.scorecard', label: 'Submit desk scorecards', kind: 'action' },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'team.resetPassword', label: 'Reset member passwords', kind: 'action' },
...
const DEFAULT_ROLE_PERMISSIONS = {
  ...
  hr_recruiter: [
    ...
    'candidates.create', 'candidates.edit',
    'applications.edit', 'applications.reject',
    'interviews.schedule', 'interviews.cancel', 'scorecards.submit',
    'freelance.scorecard',
  ],
